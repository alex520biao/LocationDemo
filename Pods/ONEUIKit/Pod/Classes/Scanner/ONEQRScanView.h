...
/**
 ...
 @param message 结果字符串
 */
- (void)scanView:(ONEQRScanView *)scanView pickUpMessage:(NSString *)message;

@end

@interface ONEQRScanView : UIView

@property (nonatomic, weak) id<ONEQRScanDelegate> delegate;
